...
- now, one frameloader object is created for each of the camera inputs. these frameloaders create a [thread](notes/definitions.md#thread) which performs the queuing of frames without blocking inference.
